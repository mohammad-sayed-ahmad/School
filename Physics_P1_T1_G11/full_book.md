...
c_water = 4.20 x 10³ J/kg x K, l_v = 2.30 x 10⁶ J/kg

(b) Calculate the heat required to convert 100 g of ice at -10°C into steam at 100 °C.
c_ice = 2.10 x 10³ J/kg x K, l_f = 3.40 x 10⁵ J/kg
```
...
```
1.47 A steel girder is 15 m long. The difference between its length on a cold winter's day and its length on a hot summer's day is Δl. Which of the following values, will Δl most likely have? (a) 0.5 cm, (b) 15 cm, (c) 50 cm, (d) 200 cm.
```
...
## C 1.7 Heat transfer by conduction
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTI2ODM5Mjk0NSwtMTkwOTQ0MTg4NCwxNj
cyMjU4NzQ4XX0=
-->